function val = periodicSingleBasisSecondDerivEval( U, u, elem, p )
% Takes a single periodic basis and returns its second derivative at a point.
...
val=basisSplineSecondDerivEval(U, U(p+1)+offset, p+1, p); %number p+1 is first spline to be like periodic splines
