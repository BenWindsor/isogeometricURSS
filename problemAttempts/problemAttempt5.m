...
%set lhs matrix
delta=1; %time step, too big?? too small??
...
S=op_f_v_tp(space, msh, @(x,y)(basisSplineEval(knots, inverseCircle(x,y), 2, 5)) ); %wont allow constant source?
rhs=(1/delta)*M*c_0+S;
...
actualField=@(x)(basisSplineEval(knots, x, 2, 5));
fplot(actualField, [0 0.9999]);
